...
public class ConferenceListServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Conference> conference_list=attendeeService.findByUserId(user_id);
        ...
        try {
            ...
            for (Conference conference : conference_list) {
                ...
                dataj.put("status",conference.getStatus());
            ...
            result.put("code", 200);
            result.put("msg", "成功");
            result.put("data", conference_list);
