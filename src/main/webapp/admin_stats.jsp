        ...
        <div class="row">
            ...
            <nav class="col-md-2 sidebar p-0">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active p-3" href="${pageContext.request.contextPath}/admin_stats.jsp">
